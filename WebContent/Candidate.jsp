...
<%
////////////////////GATHERING Author Name/ outputing TITLE HEADER
int CID = Integer.parseInt(request.getParameter("CID"));
String sql ="select FirstName, LastName from Candidate where CID = ?";  
PreparedStatement pstmt = con.prepareStatement(sql);
pstmt.setInt(1,CID);
ResultSet rst = pstmt.executeQuery();
rst.next();
...
%>
<h1>Articles About <%out.println(AuthorName);%></h1>
<table>
  <tr>
...
<% 
 ...
 // String sql = "Select ArticleTitle, Theme, UserID, Articles.CID, OwnerID,Candidate.FirstName, Candidate.LastName,ArticleID,IsSold ReleaseDate From Articles where IsSold=0 ORDERBY ReleaseDate DESC";
   sql = "Select ArticleTitle, Theme, UserID, Articles.CID, OwnerID,Candidate.FirstName, Candidate.LastName,ArticleID,IsSold, ReleaseDate, Price From Articles JOIN Candidate ON Articles.CID = Candidate.CID Where Articles.CID = ?  ORDER BY ReleaseDate DESC";
