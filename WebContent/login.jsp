...
String SQL = "select UserName, Password, UserID from Account where UserName = ? and Password = ?";
PreparedStatement pstmt = con.prepareStatement(SQL);
pstmt.setString(1, userid);
pstmt.setString(2, password);
ResultSet query = pstmt.executeQuery();
if(query.next()==true){ out.println("<b align=\"center\">Logged In!<\b>");
session.setAttribute("UserId",query.getInt(3));
String redirectURL = "FrontPage.jsp";
response.sendRedirect(redirectURL);

}
else if (userid != null) {
	out.println("<b align=\"center\">Incorrect Login, Try Again.<\b>");
	session.invalidate();
}
%>
