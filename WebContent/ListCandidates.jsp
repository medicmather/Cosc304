...
if(request.getParameter("search")==null) {
	String sql = "Select FirstName, LastName, CID, Position, PartyName from Candidate";
	PreparedStatement pstmt = con.prepareStatement(sql);
	ResultSet rst = pstmt.executeQuery();
	while(rst.next()){
	...
	String sql = "Select FirstName, LastName, CID, Position, PartyName from Candidate where Lastname= ?";
	PreparedStatement pstmt = con.prepareStatement(sql);
	...
	while(rst.next()){
	  ...
	  out.println("error Computing Candidates");
}
%>
</tr>
</table>
