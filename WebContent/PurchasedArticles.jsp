...
<table>
  ...
  String sql = "Select ArticleTitle, Theme, UserID, Articles.CID, OwnerID,Candidate.FirstName, Candidate.LastName,ArticleID From Articles JOIN Candidate ON Articles.CID = Candidate.CID where OwnerID = ?";
  PreparedStatement pstmt = con.prepareStatement(sql);
  pstmt.setInt(1, UserID);
  ResultSet rst = pstmt.executeQuery();
  while(rst.next()){
	  out.print("</tr><td><a href=\"Article.jsp?ArticleID="+rst.getInt(8)+"\">"+rst.getString(1)+"</a></td><td>"+rst.getString(6)+" "+rst.getString(7)+"</td><td>"+rst.getString(2)+"</td></tr>");
  }
	}
  catch(Exception e){
